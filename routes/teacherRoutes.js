...
import express from "express";
import { signupTeacher, loginTeacher, createCourse } from "../controllers/teacherController.js";
import { authMiddleware } from "../middleware/auth.js"; // JWT check karne ke liye
...
// 🔹 Teacher Create Course (only after login)
